...
export default function Auth() {
  ...
  const inputClasses = "bg-black/20 border border-white/10 rounded-xl text-white pl-10 px-4 py-3 placeholder:text-white/30 const inputClasses = "bg-black/20 border border-white/10 rounded-xl text-white pl-10 px-4 py-3 placeholder:text-white/30 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"; transition-all";
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full px-6 gap-12 lg:gap-20 items-center grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="flex flex-col justify-center text-white">
          ...
          <h2 className="text-5xl lg:text-7xl font-bold tracking-tight mb-6">
            Sikkerhet og{' '}
            <span className="bg-gradient-to-r <span className="bg-gradient-to-r from-blue-300 via-cyan-300 to-white bg-clip-text text-transparent"> bg-clip-text text-transparent">
              Kompetanse
            </span>{' '}
            i Fokus
          </h2>
